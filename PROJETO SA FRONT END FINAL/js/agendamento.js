document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        if (!isValid) {
            ...
            // Se o formulário for válido, redireciona para a página de confirmação
            e.preventDefault(); // Impede o envio real do formulário
            window.location.href = "confirmacao.html"; // Substitua pelo URL da sua página de confirmação
        }
    });
});
